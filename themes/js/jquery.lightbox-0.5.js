...
(function ($) {
	...
	$.fn.lightBox = function (settings) {
		...
		function _resize_container_image_box(intImageWidth, intImageHeight) {
			...
			//$('#lightbox-container-image-box').animate({ width: '94%', height: intHeight }, settings.containerResizeSpeed, function () { _show_image(); });
			$('#lightbox-container-image-box').animate({ width: '94%', height: "100%" }, settings.containerResizeSpeed, function () { _show_image(); });
			...
			$('#lightbox-container-image-data-box').css({ width: '94%' });
