...
<li class="span3">
    <div class="thumbnail">
        <a href="product_details.php?id=8"><img src="themes/images/products/7.jpg" alt="" /></a>
        <div class="caption">
            <h5>32 Gig USB</h5>
            <p>
                Lorem Ipsum is simply dummy text.
            ...
            <h4 style="text-align:center">
                <a class="btn" id="cartToggleButton8" onclick="getProductData('7.jpg', 500, '32 Gig USB', 4500, 8, 1, 100);">Add to <i class="icon-shopping-cart"></i></a>
                <a class="btn btn-primary" href="product_summary.php">$4500</a>
            </h4>
        </div>
    </div>
</li> -->